...
public class Sessio extends javax.swing.JFrame {
    ...
    private void accesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_accesActionPerformed
        ...
        if (verificarCredenciales(usuari, contrasenya)) {
            System.out.println("¡Inicio de sesión exitoso para el usuario '" + usuari + "'!");
        } else {
            Connexio.inserirUsuari(usuari, contrasenya);
            System.out.println("¡Nuevo usuario '" + usuari + "' creado con éxito!");
        }
    }//GEN-LAST:event_accesActionPerformed

private boolean verificarCredenciales(String usuari, String contrasenya) {
    Connexio.establirConnexio();

//    Connexio.mostrarColecciones();

    return Connexio.verificarCredenciales(usuari, contrasenya);
}
